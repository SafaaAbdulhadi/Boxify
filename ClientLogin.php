...
if (isset($_POST['userNameField'])) {
  ...
  $MM_redirectLoginFailed = "ClientLogin.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_ProjectConnection, $ProjectConnection);
  	
  $LoginRS__query=sprintf("SELECT username, password, user_level FROM customer WHERE username=%s AND password=%s",
...
<html lang="en" class="no-js">
	...
	<body>
				...
				<div class="container">
					...
					<div class="row hero-content">
					  <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" id="LoginForm">
                          ...
                          <table width="586" height="185" border="0">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><input type="text" id="userName" name="userNameField" class="animated fadeInRight" size="28"></td>
                             
                              </tr>
                              <tr>
                                
                                <td height="35"><label for="password" class="animated fadeInLeft">Password</label></td>
                                <td><input type="password" id="password" name="passwordField" class="animated fadeInRight" size="35">
                                </td>
                              ...
                              <td></td>
                              <td>
                              <a href="ResetPasswordForm.php"><font color="#F8F8F8"><u>Forgot your Password?</u></font></a>
                              </td>
                              </tr>
                        ...
                        <div class="col-md-12">
							<input name="submitButton" type="submit" class="use-btn animated fadeInUp" id="submitButton" value="Login">
					</div>
                    </form>
				</div>
			</section>
		...
		<div class="overlay overlay-boxify">
			<nav>
				<ul>
					<li><a href="index.php"><i class="fa fa-briefcase"></i>Home</a></li>
				</ul>
				<ul>
					<li><a href="register.php"><i class="fa fa-desktop"></i>Sign up</a></li>
