...
if (isset($_POST['userNameField'])) {
  ...
  $MM_redirectLoginSuccess = "serviceControlPanel.php";
  $MM_redirectLoginFailed = "serviceLogin.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_ProjectConnection, $ProjectConnection);
  
  $LoginRS__query=sprintf("SELECT user_name, password FROM service_providers WHERE user_name=%s AND password=%s",
			...
			<section class="hero">
				...
				<div class="container">
					...
					<div class="row hero-content">
						<form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" id="LoginForm" name="AdminLoginForm">
                        <div align="center">
                          <p>&nbsp;</p>
                          <p>&nbsp;</p>
                          <p>&nbsp;</p>
                          ...
                          <table width="586" height="185" border="0">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><input type="password" id="password" name="passwordField" class="animated fadeInRight" size="35"></td>
