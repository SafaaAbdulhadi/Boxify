...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "updateForm")) {
  $updateSQL = sprintf("UPDATE service_providers SET firstName=%s, lastName=%s, email=%s, phoneNO=%s, address=%s WHERE id=%s",
			...
			<section class="hero">
				...
				<div class="container">
					...
					<div class="row hero-content">
					  <form action="<?php echo $editFormAction; ?>" method="POST"  name="updateForm" id="Updateform">
                        ...
                        <br><br>
                          <h2> Hello <?php echo $row_Recordset1['firstName']; ?><br>
                            <br>
                          Please Edit Your Details Below</h2>
                          ...
                          <table width="586" height="185" border="0">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td height="35"><label for="phone" class="animated fadeInLeft">Address</label></td>
                                <td><input name="address" type="text" class="animated fadeInRight" id="phone"></td>
                             
                              </tr>
                              
                            </tbody>
                          </table>
                          <p><input type="hidden" name="customerID" value="<?php echo $_POST['userID']?>"></p>
                      </div>
                     ...
                     <a href="serviceControlPanel.php" style="float:right" class="use-btn animated fadeInRightBig">Main Menu</a>     
