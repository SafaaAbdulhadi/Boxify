...
if (isset($_POST['userId'])) {
  $colname_Recordset2 = $_POST['userId'];
}
mysql_select_db($database_ProjectConnection, $ProjectConnection);
$query_Recordset2 = sprintf("SELECT order_id FROM order_table WHERE customerID = %s", GetSQLValueString($colname_Recordset2, "int"));
                    ...
                    <table width="586" height="113" border="0">
                            <tbody>
                              ...
                              <td height="35"><?php echo $row_Recordset1['email']; ?></td >
                                    ...
                                    <tr>
                                    <th height="35" class="animated fadeInLeft">Orders Made</th>
                                    <td height="35" ><p><?php echo $totalRows_Recordset2 ?></p>
                                    </td>
                                    </tr>
                                    </form>
                                    </tr>
