                    ...
                    <table width="586" height="113" border="0">
                            <tbody>
                              ...
                              <td height="35"><?php echo $row_Recordset1['time']; ?></td >
                                    ...
                                    <td height="35" class="animated fadeInLeft">Status</td>
                                    <td height="35"><p><?php echo $row_Recordset1['order_status']; ?>
                                    &nbsp; 
                                    ...
                                    <tr>
                                      ...
                                      <th height="35" class="animated fadeInLeft">Customer ID</th>
                                    <td height="35">&nbsp;&nbsp;<?php echo $row_Recordset1['customerID']; ?></td><tr><td></td><td>
                                    <form method="post" name="userDetails" action="viewUserAdmin.php">
                                    <input name="userId" type="hidden" value="<?php echo $row_Recordset1['customerID']; ?>">
                                    <input name="View User Details2" type="submit" value="View details">
                                    </form>
                        ...
                        <div class="col-md-12"  align="right">
						  <a href="ManageOrdersAdmin.php" class="use-btn animated fadeInDown">Back to list</a>
