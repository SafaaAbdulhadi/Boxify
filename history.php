...
$query_Recordset1 = sprintf("SELECT * FROM order_table WHERE customerID = %s", GetSQLValueString($colname_Recordset1, "int"));
					...
					<div class="row hero-content">
                      ...
                      <div class="features-slider-List" align="center">
                        <ul class="slides" id="featuresSlider">
						  ...
						  { ?>
                          <li><form action="ViewOrderClient.php" method="post">
                          <h2><u><?php echo $row_Recordset1['date']; ?>&nbsp;<?php echo $row_Recordset1['time']; ?> &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_Recordset1['price']." GP"; ?></u><br>
                          <?php echo $row_Recordset1['serviceName']; ?><br>
                          <input type="submit" value="View Details" class="download-btn">
                          
                          
                          <input type="hidden" name ="SelectedRow" value="<?php echo $row_Recordset1['order_id']; ?>"></h3>
                          </form></li>
                          <?php }; ?>
                          </ul>
                                         </div>
