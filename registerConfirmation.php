				...
				<div class="container">
					...
					<div class="row hero-content">
                        ...
                        <div align="center">
                          ...
                          <p>&nbsp;</p>
                          <p>&nbsp;</p>
                          <h2 class="animated fadeInDownBig">
                          Thank You! You have been registerd in our system, <br>
                       		 You can now use our services! 
                        </div>
                        <div class='col-md-12' align='center'>
                        <br>
                        <br>
							 <a href="ClientLogin.php" class="use-btn animated fadeInUp">Login</a>
                             <a href="index.php" class="use-btn animated fadeInUp">Home</a>
					</div>
