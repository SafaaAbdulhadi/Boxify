...
$query_completed = "SELECT * FROM order_table WHERE order_status = 'Completed'";
$completed = mysql_query($query_completed, $ProjectConnection) or die(mysql_error());
$row_completed = mysql_fetch_assoc($completed);
$totalRows_completed = mysql_num_rows($completed);

mysql_select_db($database_ProjectConnection, $ProjectConnection);
$query_inProgress = "SELECT * FROM order_table WHERE order_status = 'In Progress'";
...
mysql_select_db($database_ProjectConnection, $ProjectConnection);
$query_new = "SELECT * FROM order_table WHERE order_status = 'New'";
		...
		<header>
			<section class="hero">
				...
				<div class="container">
                    ...
                    <h2 class="animated fadeInDown" align="center"><u>New Orders</u></h2>
                          ...
                          <table width="824" border="1" class="animated fadeInLeftBig">
                            <tbody>
                              <tr>
                                ...
                                <th width="172" align="center">Service Name</th>
                           ...
                           <?php while ($row_new = mysql_fetch_assoc($new))
						   {
							   ?>
                                ...
                                <td><?php echo $row_new['serviceName']; ?></td>
                                <td><?php echo $row_new['date_made']; ?></td>
                                <td><?php echo $row_new['order_status']; ?></td>
                                <td><form name="viewOrderAdmin" method="post" action="ViewOrderAdmin.php"><input type="submit" value="View Details">
                    ...
                    <br><br>
                    <h2 class="animated fadeInDown" align="center"><u>In Progress</u></h2>
                          ...
                          <table width="824" border="1" class="animated fadeInLeftBig">
                           ...
                           <?php while ($row_inProgress = mysql_fetch_assoc($inProgress))
						   {
							   ?>
                                ...
                                <td><?php echo $row_inProgress['serviceName']; ?></td>
                        ...
                        <br><br>
                        <h2 class="animated fadeInDown" align="center"><u>Completed Orders</u></h2>
                        ...
                        <div align="center">
                          ...
                          <table width="824" border="1" class="animated fadeInLeftBig">
                           ...
                           <?php while ($row_completed = mysql_fetch_assoc($completed))
						   {
							   ?>
								  <tr>
                                  
                                <td><?php echo $row_completed['order_id']; ?></td>
                                <td><?php echo $row_completed['serviceName']; ?></td>
                                <td><?php echo $row_completed['date_made']; ?></td>
                                <td><?php echo $row_completed['order_status']; ?></td>
                                <td><form name="viewOrderAdmin" method="post" action="viwCompletedOrdersAdmin.php"><input type="submit" value="View Details">
                          
                          
                          <input type="hidden" name ="SelectedRow" value="<?php echo $row_completed['order_id']; ?>"></form></td>
