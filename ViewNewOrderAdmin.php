...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "assign")) {
  ...
  $updateGoTo = "AdminControlPanel.php";
  if (isset($_SERVER['QUERY_STRING'])) {
			...
			<section class="hero">
				...
				<div class="container">
                    ...
                    <table width="586" height="113" border="0">
                            <tbody>
                              <tr>
                                <td width="131" height="35"><label  class="animated fadeInLeft">Order No.</label></td>
                                <td width="445"><?php echo $row_Recordset1['order_id']; ?></td>
                              </tr>
                              <tr>
                                
                                <td height="35"><label  class="animated fadeInLeft" id="forList">Service Name </label></td>
                                <td><?php echo $row_Recordset1['serviceName']; ?></td>
                              </tr>
                              <tr>
                                <td height="35"><label  class="animated fadeInLeft">Duration</label></td>
                                <td><p><?php echo $row_Recordset1['duration']; ?></p>
                                </td>
                              </tr>
                              <tr>
                               <td height="35"><label class="animated fadeInLeft" >Time</label></td>
                            ...
                            <a href="NewOrdersAdmin.php" class="use-btn animated fadeInDown" style="float:right">Back to list</a>
                        <form action="assignNewOrdersAdmin.php" name="assign" method="POST" > 
                                    <input type="hidden" name="order" value="<?php echo $row_Recordset1['order_id']; ?>">
              
                       
                                    <input type="submit" value="Assign" class="use-btn animated fadeInDown" style="float:right">
