			...
			<section class="hero">
				...
				<div class="container">
					...
					<div class="row hero-content">
					  <form action="NewPasswordPage.php" method="POST"  name="updateForm" id="ResetPassword">
                      
                        <div align="center" class="animated fadeInDownBig">
                        <br>
                        <br><br>
                        <table width="586" height="150" border="0">
                          <tbody>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td height="35"><label for="email" class="animated fadeInLeft">Personal Code</label></td>
                                <td><input name="PersonalCode" type="text" class="animated fadeInRight" id="phone"></td>
