...
$query_Recordset1 = sprintf("SELECT * FROM order_table WHERE customerID = %s AND order_status= 'New'", GetSQLValueString($colname_Recordset1, "int"));
...
<body>
			...
			<section class="hero">
				...
				<div class="container">
					...
					<div class="row hero-content">
						<div class="col-md-12">
						  <h1 class="animated fadeInDown">Welcome Back, <?php echo $name ?><br>
                          You Have <?php echo $totalRows_Recordset1 ?> standing orders!</h1>
                          <div>
                          
							<a href="service.php" class="use-btn animated fadeInLeft">Book a service!</a>
                            <a href="history.php" class="use-btn animated fadeInUp">View History</a>
                            <a href="UserAccountUpdate.php" class="use-btn animated fadeInDown">Manage Account</a>
                            </ul>
                            </nav>
                            </div>
		...
		<div class="overlay overlay-boxify">
			<nav>
				<ul>
					<li><a href="service.php"><i class="fa fa-briefcase"></i>Services</a></li>
					<li><a href="logout.php"><i class="fa fa-desktop"></i>Logout</a></li>
				</ul>
				<ul>
