                    ...
                    <table width="586" height="113" border="0">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td height="35"><label  class="animated fadeInLeft" id="forList">What </label></td>
                                <td><?php echo $row_Recordset1['serviceName']; ?></td>
                              </tr>
                              <tr>
                                <td height="35"><label  class="animated fadeInLeft">How long? </label></td>
                                <td><p><?php echo $row_Recordset1['duration']; ?></p>
                                </td>
                              </tr>
                              <tr>
                               <td height="35"><label class="animated fadeInLeft" >What time? </label></td>
                              <td height="35"><?php echo $row_Recordset1['time']; ?></td >
                              </tr>
                                    <tr>
                                    <th height="35" class="animated fadeInLeft">What day?</th>
                                    <td height="35"><p><?php echo $row_Recordset1['date']; ?></p>
                                    </td>
                                    </tr>
                                    <tr>
                                    <th height="35" class="animated fadeInLeft">How Much?</th>
                                    <td height="35" ><p><?php echo $row_Recordset1['price']; ?></p>
                                    </td>
                                    </tr>
                                    <tr>
                                    <th height="35" class="animated fadeInLeft">Where?</th>
                                    <td height="35"><p><?php echo $row_Recordset1['adress']; ?></p>
                                    </td>
                                    </tr>
                                    <tr>
                                    <th height="35" class="animated fadeInLeft">When did I make it?</th>
                                    <td height="35"><p><?php echo $row_Recordset1['date_made']; ?></p>
                                    </td>
                                    </tr>
                                    <tr>
                                    <th height="35" class="animated fadeInLeft">Status</th>
                                    <td height="35"><p><?php echo $row_Recordset1['order_status']; ?></p>
                                    </td>
                                    </tr>
                            </tbody>
                         </table>
                        ...
                        <div class="col-md-12"  align="right">
						  <a href="history.php" class="use-btn animated fadeInDown">Back</a>
                          <a href="ClientHomePage.php" class="use-btn animated fadeInDown">Main Menu</a>
					</div>
